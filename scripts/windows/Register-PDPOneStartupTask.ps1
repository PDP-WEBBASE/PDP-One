...
param(
    ...
    [string]$PublicEdgeWatchdogTaskName = "PDP One Public Edge Watchdog",
...
$publicEdgeWatchdogScript = Join-Path $ProjectRoot "scripts\windows\Ensure-PDPOnePublicEdgeHealthy.ps1"
