...
def _start(request, payload):
    ...
    from procurement.analysis_workflow import normalize_limit, serialize_work
    from procurement.analysis_workflow_postgres import start_analysis_request
    ...
    try:
        analysis_request = AnalysisRequest.objects.create(
            ...
            metadata={
                "acceptance_id": ACCEPTANCE_ID,
                "bridge": "analysis-report-reserved-command-v4",
