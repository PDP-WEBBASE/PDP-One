from . import procurement_analysis_bridge_v6 as analysis_base
from . import procurement_analysis_bridge_v7 as base


ACCEPTANCE_ID = analysis_base.ACCEPTANCE_ID
PREFLIGHT_COMMAND = analysis_base.PREFLIGHT_COMMAND
START_COMMAND = analysis_base.START_COMMAND
SAVE_COMMAND = analysis_base.SAVE_COMMAND
FINISH_COMMAND = analysis_base.FINISH_COMMAND
RESERVED_COMMANDS = analysis_base.RESERVED_COMMANDS
